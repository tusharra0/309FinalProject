    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
        ...
        <Route path="/organizer">
          ...
          <Route path="events/new" element={<ManagerEventForm basePath="/organizer" />} />
          <Route path="events/:eventId" element={<EventManagement basePath="/organizer" />} />
          <Route path="events/:eventId/edit" element={<ManagerEventForm basePath="/organizer" />} />
        </Route>
